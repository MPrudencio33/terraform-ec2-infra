...
instance_type               = "t2.micro" 
  ...
  key_name                    = "marlon-key-pair" #Change to your keyname, e.g. jazeel-key-pair 
  vpc_security_group_ids = [aws_security_group.allow_ssh.id] 
  
  tags = { 
    Name = "marlon-ec2"    #Prefix your own name, e.g. jazeel-ec2 
  } 
} 
 
resource "aws_security_group" "allow_ssh" { 
  name        = "marlon-terraform-security-group" #Security group name, e.g. jazeel-terraform-security-group 
